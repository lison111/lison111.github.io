...
1. 첫 번째 스테이지는 가정 집의 안방을 모티브로 구현합니다. (김태랑 및 윤홍인)
2. 첫 번째 스테이지에서 필요로 하는 오브젝트를 수집 및 제작합니다. (김태랑)
3. 첫 번째 스테이지에서 플레이어와 상호작용 하는 오브젝트에 기능을 구현합니다(윤홍인)
<br>
작업 내용 :

1. 첫 번째 스테이지의 형태를 디자인합니다. (김태랑 / 100%)
2. Unity 프로젝트에서 Cube를 통해 디자인된 첫 번째 스테이지를 제작합니다. (윤홍인 / 100%)
3. 첫 번째 스테이지의 벽 재질과 이미지를 수집하고 제작합니다. (김태랑 / 100%)
4. 첫 번째 스테이지의 벽에 수집 및 제작한 재질과 이미지를 적용합니다. (윤홍인 / 100%)
5. 첫 번째 스테이지에 필요로 하는 오브젝트를 AssetStore에서 수집 및 제작합니다. (김태랑 / 100%)
6. 첫 번째 스테이지에 어떻게 오브젝트를 배치할지 디자인합니다. (김태랑 / 100%)
7. 첫 번째 스테이지에 수집 및 제작된 오브젝트를 배치합니다. (윤홍인 / 100%)
8. 첫 번째 스테이지에서 플레이어와 상호작용 하는 오브젝트에 들어갈 Script를 작성합니다. (윤홍인 / 100%)
9. 첫 번째 스테이지에서 플레이어와 상호작용 하는 오브젝트에 기능을 적용합니다. (윤홍인 / 100%)
<br>
