...
|연번|오브젝트 이름|오브젝트 이미지|  
|:---:|:---:|:---:|  
|1|주인공|<img src = "./img/주인공.png" width = "300">| 
|2|흑막|<img src = "./img/흑막.png" width = "300">| 
|3|일기|<img src = "./img/일기.jpg" width = "300">| 
|4|거울|<img src = "./img/거울.png" width = "300">|  
|5|사진|<img src = "./img/사진1.png" width = "300">|   
|6|꽃|<img src = "./img/꽃.png" width = "300">|         
|7|열쇠|<img src = "./img/열쇠.png" width = "300">|  
|8|문|<img src = "./img/문.png" width = "300">|     
|9|신문|<img src = "./img/신문.jpg" width = "300">|  
|10|문제|<img src = "./img/문제.jpg" width = "300">|  
...
1. 각 방을 하나의 스테이지로 간주합니다.
2. 방 안의 사물들을 상호작용하여 힌트, 문제, 아이템을 획득 및 해결해 방문을 열어 다음 스테이지로 진행합니다.
3. 어떤 물체가 상호작용 가능한지 게임은 알려주지 않고 플레이어가 직접 방을 돌아다니며 어떤 아이템이 상호작용 가능한지 확인해야 합니다.
4. 플레이어가 모든 방을 클리어하여 마지막 문을 열고 탈출하면 게임이 클리어 됩니다.

### 2)보조규칙  
1. 방 안에서 문제를 발견했다면 주변의 물체 및 아이템에서 얻은 힌트를 바탕으로 문제를 풀고 이를 통해 얻은 아이템과 정보를 이용해 방 문 열쇠를 얻어 방의 문을 열어야 합니다.
...
3. 플레이어는 문제와 힌트 외에도 게임의 스토리와 의미를 파악하기 위한 오브젝트들이 있습니다.
4. 이전 방에서 발견한 힌트는 다음 방에서 활용될 수 있습니다.
...
<img src="./img/방2 평면도.png">

<img src="./img/방2 벽1.png">

<img src="./img/방2 벽2.png">

<img src="./img/방2 벽3.png">

<img src="./img/방2 벽4.png">
...
<img src="./img/방3 평면도.png">

<img src="./img/방3 작은방1 평면도.png">

<img src="./img/방3 작은방2 평면도.png">

<img src="./img/방3 작은방3 평면도.png">

<img src="./img/방3 작은방4 평면도.png">
...
- ~~메뉴화면에는 게임새로시작 버튼과 게임설정 버튼, 게임종료로 총 3개의 버튼으로 구성되어 있습니다.~~
